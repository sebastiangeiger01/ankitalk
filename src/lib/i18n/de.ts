export const de: Record<string, string> = {
	...
	'settings.agent.setupStep4': 'Kopiere die Agent-ID (beginnt mit „agent_…“) und füge sie unten ein.',
	...
	'settings.agent.readiness.issues.agent_session_unavailable': 'ElevenLabs findet den Agent, kann aber keine Tutor-Sitzungsdaten erstellen. Versuche es erneut und prüfe anschließend Agent-ID und ElevenAgents-Leseberechtigung.',

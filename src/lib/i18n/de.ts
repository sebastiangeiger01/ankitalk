export const de: Record<string, string> = {
	...
	'settings.agent.agentIdHelp': 'Lege im ElevenLabs-Dashboard einen leeren Agent an und füge dessen ID hier ein. AnkiTalk überschreibt Prompt, Stimme und Sprache pro Gespräch, daher ist die Konfiguration des Agents selbst egal.',

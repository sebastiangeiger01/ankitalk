export const de: Record<string, string> = {
	...
	'settings.apiKeys.elevenlabsPerms.agents': 'ElevenAgents (Lesen) — Tutor-Sitzungen und Prüfung der MCP-Einrichtung',
	...
	'settings.agent.setupScopeWarning': 'Aktiviere bei einem eingeschränkten ElevenLabs-Schlüssel „ElevenAgents — Lesen“ (Scope: convai_read). Schreibzugriff ist nicht nötig.',
	...
	'settings.agent.readiness.issues.insufficient_permissions': 'Aktiviere für diesen ElevenLabs-API-Schlüssel „ElevenAgents — Lesen“. Schreibzugriff ist nicht nötig.',

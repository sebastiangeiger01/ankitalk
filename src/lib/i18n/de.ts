export const de: Record<string, string> = {
	...
	'review.missingKeysDetail': 'Füge in den Einstellungen die API-Schlüssel für deine gewählten Sprachdienste hinzu.',
	...
	// Voice provider
	'settings.voice.ttsTitle': 'Kartenaudio',
	'settings.voice.ttsDesc': 'Welcher Dienst deine Karten vorliest.',
	'settings.voice.sttTitle': 'Sprachbefehle',
	'settings.voice.sttDesc': 'Welcher Dienst während der Abfrage auf dein Mikrofon hört.',
	'settings.voice.elevenlabs': 'ElevenLabs',
	'settings.voice.openai': 'OpenAI',
	'settings.voice.deepgram': 'Deepgram',
	'settings.voice.ttsElevenlabsDesc': 'Natürliche Stimmen, einstellbar im Stimmenstudio unten. Empfohlen.',
	'settings.voice.ttsOpenaiDesc': 'Standardstimmen über deinen OpenAI-API-Schlüssel.',
	'settings.voice.sttElevenlabsDesc': 'Scribe-Transkription in Echtzeit. Verbraucht ElevenLabs-Credits.',
	'settings.voice.sttDeepgramDesc': 'Lässt das dauerhaft aktive Mikrofon über Deepgram laufen – spart ElevenLabs-Credits.',
	'settings.voice.keyMissing': 'Füge oben deinen {service}-API-Schlüssel hinzu, um diese Option zu nutzen.',
	...
	'settings.apiKeys.advancedDesc': 'Optionale Schlüssel für alternative Sprachdienste und KI-Erklärungen.',
	...
	'listen.downloadCostBody': 'Für {count} noch nicht erzeugte Sätze werden dabei rund {credits} Credits verbraucht — bereits erzeugte Sätze kosten nichts. Sie bleiben danach gespeichert, das Anhören ist also ebenfalls kostenlos.',
	'listen.downloadStarted': 'Download gestartet.',
	'listen.downloadError': 'Download nicht möglich. Prüfe deinen ElevenLabs-Schlüssel in den Einstellungen.',
	'listen.downloadStart': 'Herunterladen',
	'listen.downloadGenerating': 'Audio wird erzeugt … {done} / {total} Sätze',
	'listen.downloadKeepOpen': 'Lass die Seite so lange offen. Der Fortschritt bleibt gespeichert — abbrechen und später weitermachen kostet nichts doppelt.',
	'listen.downloadCancelled': 'Abgebrochen. Die bereits erzeugten Sätze bleiben gespeichert.',
	...
	'agent.prompts.title': 'Was brauchst du?',
	'agent.prompts.hint': 'Gib mir einen Hinweis',
	'agent.prompts.approach': 'Wie gehe ich an die Frage heran?',
	'agent.prompts.term': 'Erkläre einen Begriff aus der Frage',
	'agent.prompts.recognize': 'Woran erkenne ich die richtige Antwort?',
	'agent.prompts.explainAnswer': 'Erkläre die Antwort',
	'agent.prompts.whyAnswer': 'Warum ist das die Antwort?',
	'agent.prompts.mnemonic': 'Gib mir eine Eselsbrücke',
	'agent.prompts.example': 'Nenne ein Beispiel aus dem Alltag',
	'agent.prompts.orHint': '…oder tippe deine Frage unten ein.',
	'agent.prompts.orHintPtt': '…oder tippe unten, oder halte Sprechen gedrückt.',

export const en: Record<string, string> = {
	...
	'settings.agent.agentIdHelp': 'Create an empty agent in your ElevenLabs dashboard and paste its ID here. AnkiTalk overrides the prompt, voice, and language per conversation, so the agent’s own configuration doesn’t matter beyond existing.',

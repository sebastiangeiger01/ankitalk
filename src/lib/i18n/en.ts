export const en: Record<string, string> = {
	...
	'settings.agent.setupStep4': 'Copy the agent ID (starts with “agent_…”) and paste it into the field below.',
	...
	'settings.agent.readiness.issues.agent_session_unavailable': 'ElevenLabs found the agent but could not create Tutor session credentials. Try again, then check the Agent ID and ElevenAgents Read permission.',

export const en: Record<string, string> = {
	...
	'settings.apiKeys.elevenlabsPerms.agents': 'ElevenAgents (Read) — tutor sessions and MCP setup verification',
	...
	'settings.agent.setupScopeWarning': 'For a restricted ElevenLabs key, enable “ElevenAgents — Read” (scope: convai_read). Write access is not required.',
	...
	'settings.agent.readiness.issues.insufficient_permissions': 'Enable “ElevenAgents — Read” for this ElevenLabs API key. Write access is not required.',

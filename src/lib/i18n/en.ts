export const en: Record<string, string> = {
	...
	'review.missingKeysDetail': 'Add the API keys for your selected speech services in Settings.',
	...
	// Voice provider
	'settings.voice.ttsTitle': 'Card audio',
	'settings.voice.ttsDesc': 'Which service reads your cards aloud.',
	'settings.voice.sttTitle': 'Voice commands',
	'settings.voice.sttDesc': 'Which service listens to your microphone during review.',
	'settings.voice.elevenlabs': 'ElevenLabs',
	'settings.voice.openai': 'OpenAI',
	'settings.voice.deepgram': 'Deepgram',
	'settings.voice.ttsElevenlabsDesc': 'Natural voices, tuned in the voice studio below. Recommended.',
	'settings.voice.ttsOpenaiDesc': 'Standard voices via your OpenAI API key.',
	'settings.voice.sttElevenlabsDesc': 'Realtime Scribe transcription. Uses ElevenLabs credits.',
	'settings.voice.sttDeepgramDesc': 'Runs the always-on review mic through Deepgram — saves ElevenLabs credits.',
	'settings.voice.keyMissing': 'Add your {service} API key above to use this option.',
	...
	'settings.apiKeys.advancedDesc': 'Optional keys for alternative speech providers and AI explanations.',
	...
	'settings.apiKeys.edit': 'Edit key',
	...
	'listen.downloadCostBody': 'This will spend roughly {credits} credits on {count} sentences that are not generated yet — sentences you already have cost nothing. They stay cached afterwards, so listening is free too.',
	'listen.downloadStarted': 'Download started.',
	'listen.downloadError': 'Download unavailable. Check your ElevenLabs key in Settings.',
	'listen.downloadStart': 'Download',
	'listen.downloadGenerating': 'Generating audio … {done} / {total} sentences',
	'listen.downloadKeepOpen': 'Keep this page open. Progress is saved — cancelling and resuming later costs nothing twice.',
	'listen.downloadCancelled': 'Cancelled. Sentences generated so far stay saved.',
	...
	'agent.prompts.title': 'What do you need?',
	'agent.prompts.hint': 'Give me a hint',
	'agent.prompts.approach': 'How should I approach this question?',
	'agent.prompts.term': 'Explain a term from the question',
	'agent.prompts.recognize': 'How can I recognize the right answer?',
	'agent.prompts.explainAnswer': 'Explain the answer',
	'agent.prompts.whyAnswer': 'Why is that the answer?',
	'agent.prompts.mnemonic': 'Give me a mnemonic',
	'agent.prompts.example': 'Give me a real-world example',
	'agent.prompts.orHint': '…or type your question below.',
	'agent.prompts.orHintPtt': '…or type below, or hold Talk to speak.',

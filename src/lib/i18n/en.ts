export const en: Record<string, string> = {
	...
	'settings.agent.setupStep4': 'In Security, enable authentication and allow the System prompt, Language, and Voice ID overrides.',
	...
	'settings.agent.readiness.overrides': 'Prompt, language, and voice overrides are enabled',

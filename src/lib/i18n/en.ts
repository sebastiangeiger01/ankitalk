export const en: Record<string, string> = {
	...
	'settings.agent.agentIdHelp': 'AnkiTalk overrides the prompt, voice, and language per conversation, so the agent’s own configuration doesn’t matter beyond existing.',
